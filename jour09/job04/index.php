...
informations des étudiants dont prenom commence par un “T”. Affichez le résultat de cette requête dans un tableau html. 
...
try {
    ...
    $requete = "SELECT prénom, nom, naissance, sexe, email from étudiants where prénom like 't%'";
...
<!-- 
Prénom	Nom	Naissance	Sexe	Email
